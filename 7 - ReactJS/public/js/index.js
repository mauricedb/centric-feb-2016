...
/***/ function(module, exports, __webpack_require__) {
	...
	var Greeter = function (_React$Component) {
	    ...
	    function Greeter(props) {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Greeter).call(this, props));
	    }
	...
	var Clock = function (_React$Component2) {
	    ...
	    function Clock(props) {
	        ...
	        var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(Clock).call(this, props));
	...
	var HelloWorld = React.createClass({
	    ...
	    render: function render() {
	        ...
	        if (this.state.clicked) {
	            var movies = React.createElement(MoviesConnector, null);
	        }

	        return React.createElement(
	            'div',
	            null,
	            React.createElement(Toolbar, { className: "bold" }),
	            React.createElement(
	                'button',
	                { onClick: function onClick() {
	                        _this4.setState({ clicked: !_this4.state.clicked });
	                    } },
	                'Click me to show movies'
	            ),
	            movies,
	            React.createElement(Clock, { name: name }),
	            React.createElement(HelloWorldBody, null)
	        );
	    }
	});
	...
	var MovieList = function (_React$Component4) {
	    _inherits(MovieList, _React$Component4);
	...
	var MoviesConnector = function (_React$Component5) {
	    _inherits(MoviesConnector, _React$Component5);

	    function MoviesConnector(props) {
	        _classCallCheck(this, MoviesConnector);

	        var _this7 = _possibleConstructorReturn(this, Object.getPrototypeOf(MoviesConnector).call(this, props));
	    ...
	    _createClass(MoviesConnector, [{
	        key: 'componentWillMount',
	        value: function componentWillMount() {
	            var _this8 = this;

	            fetch('/api/movies').then(function (resp) {
	                return resp.json();
	            }).then(function (movies) {
	                return _this8.setState({ movies: movies });
	            });
	        }
	    }, {
	        key: 'render',
